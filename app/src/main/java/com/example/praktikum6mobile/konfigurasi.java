...
public class konfigurasi {
    ...
    public static final String URL_ADD = "http://192.168.1.10/Mobile6/insert.php";
    public static final String URL_GET_ALL = "http://192.168.1.10/Mobile6/read.php";
    public static final String URL_GET_MHS = "http://192.168.1.10/Mobile6/select.php?id=";
    public static final String URL_UPDATE_MHS = "http://192.168.1.10/Mobile6/update.php";
    public static final String URL_DELETE_MHS = "http://192.168.1.10/Mobile6/delete.php?id=";
