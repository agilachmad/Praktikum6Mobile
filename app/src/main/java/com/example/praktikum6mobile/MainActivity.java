    ...
    private void addMahasiswa(){
        ...
        class AddMahasiswa extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... v) {
                ...
                params.put(com.example.praktikum6mobile.konfigurasi.KEY_MHS_NAMA,nama);
                params.put(com.example.praktikum6mobile.konfigurasi.KEY_MHS_JURUSAN,jurusan);
                params.put(com.example.praktikum6mobile.konfigurasi.KEY_MHS_EMAIL,email);
                com.example.praktikum6mobile.RequestHandler rh = new com.example.praktikum6mobile.RequestHandler();
                String res = rh.sendPostRequest(com.example.praktikum6mobile.konfigurasi.URL_ADD, params);
                return res;
            }
        }
